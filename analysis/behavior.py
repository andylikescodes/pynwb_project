...
def plot_behavioral_graphs():
    ...
    for filename in filenames:
        ...
        is_included = check_inclusion(recog_response, auc)
        ...
        if is_included:
            ...
            correct_inds, incorrect_inds = correct_incorrect_indexes(recog_response, ground_truth)

            # remap response
            remapped_response = remap_response(recog_response)
